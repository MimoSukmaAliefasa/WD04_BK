            ...
            <div class="bg-white shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('pasien.janji-periksa.store') }}" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" value="{{ $no_rm }}" class="mt-1 block w-full rounded-md border-gray-300" readonly>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="keluhan" rows="3" class="mt-1 block w-full rounded-md border-gray-300" required></textarea>
                    </div>
